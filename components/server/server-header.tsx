  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
        ...
        {isAdmin && (
          <DropdownMenuItem className="text-rose-500 px-3 py-2 flex items-center text-sm cursor-pointer">
            Delete server
        ...
        {!isAdmin && (
          <DropdownMenuItem
            ...
            className="text-rose-500 px-3 py-2 flex items-center text-sm cursor-pointer"
          >
            Leave server
